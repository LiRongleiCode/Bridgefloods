...
<p align="center">
  感谢 <a href="https://pay.ldxp.cn/shop/1WG3HDDW"><strong>passion8.cc</strong></a> 赞助本项目。<br>
...
| Windows | [`windows/`](./windows/) | 运行 [`build-dream-skin.ps1`](./windows/scripts/build-dream-skin.ps1) 生成 `DreamSkin.exe`，或直接使用 PowerShell 脚本 |
