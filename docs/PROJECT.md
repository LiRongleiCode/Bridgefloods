...
> GitHub：https://github.com/LiRongleiCode/Bridgefloods
...
- **远程**：`origin` → `https://github.com/LiRongleiCode/Bridgefloods.git`
- **分支**：`main`
...
- 注册链：`https://pay.ldxp.cn/shop/1WG3HDDW`
- README 调性：更智能的连接 / 满血 AI 中转 / 官方模型、无降智无套壳 / 一行接 Codex·Claude Code·Grok  
- 固定声明：换肤与 API 配置互相独立  

Logo 资源：`docs/images/xiaoqiaohongshui.png`（及 svg）。
