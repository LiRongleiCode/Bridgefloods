...
<p align="center">
  <a href="https://pay.ldxp.cn/shop/1WG3HDDW">
    <img src="docs/images/xiaoqiaohongshui.png" alt="XiaoQiaoHongShui" height="72">
  </a>
</p>
...
<p align="center">
  Thanks to <a href="https://pay.ldxp.cn/shop/1WG3HDDW"><strong>XiaoQiaoHongShui</strong></a> for sponsoring this project.<br>
...
| Windows | [`windows/`](./windows/) | Run [`build-dream-skin.ps1`](./windows/scripts/build-dream-skin.ps1) to generate `DreamSkin.exe`, or use the PowerShell scripts directly |
